package pers.lichen.weixin.mp.config;
...
import pers.lichen.weixin.mp.handler.KfSessionHandler;
import pers.lichen.weixin.mp.handler.LocationHandler;
import pers.lichen.weixin.mp.handler.LogHandler;
import pers.lichen.weixin.mp.handler.MenuHandler;
import pers.lichen.weixin.mp.handler.MsgHandler;
import pers.lichen.weixin.mp.handler.NullHandler;
import pers.lichen.weixin.mp.handler.ScanHandler;
import pers.lichen.weixin.mp.handler.StoreCheckNotifyHandler;
import pers.lichen.weixin.mp.handler.SubscribeHandler;
import pers.lichen.weixin.mp.handler.UnsubscribeHandler;
